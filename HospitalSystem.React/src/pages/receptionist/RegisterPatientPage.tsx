...
import { phoneNumberSchema, NAME_REGEX, nationalIdSchema } from '../../utils/validation';
import { bloodTypes } from '../../utils/bloodTypes';

const schema = z.object({
  fullName: z.string().min(1, 'Full name is required').regex(NAME_REGEX, 'Full Name cannot contain numbers or special characters.').max(100, 'Full Name cannot exceed 100 characters'),
